    ...
    <footer className="bg-white border-t border-surface-200 text-slate-500 py-5 text-xs mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-slate-700">{t('Enterprise Warehouse Asset Management Platform')}</span>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-1 text-emerald-600">
            ...
            <span>{t('Supabase RLS Protected')}</span>
          </div>
        </div>

        {/* Right: Copyright */}
        <div className="text-slate-400">
          © {new Date().getFullYear()} {t('Enterprise Asset Control Inc. All rights reserved.')}
        </div>
