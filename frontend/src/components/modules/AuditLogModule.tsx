  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 glass-panel p-5">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-0.5">
            Full forensic audit history tracking every asset modification, checkout, repair, calibration, and role change.
          </p>
        </div>
      ...
      <div className="glass-panel p-5 space-y-4">
        <h3 className="font-bold text-sm text-slate-800">System Activity Trail ({filteredLogs.length} events logged)</h3>
          ...
          <table className="w-full text-left text-xs">
            <thead>
              <tr className="bg-surface-50 border-b border-surface-200 text-[11px] uppercase tracking-wider text-slate-400">
                ...
                <th className="px-4 py-3 font-semibold">Performed User</th>
                <th className="px-4 py-3 font-semibold">Role</th>
                <th className="px-4 py-3 font-semibold">Entity</th>
                <th className="px-4 py-3 font-semibold">Action</th>
                <th className="px-4 py-3 font-semibold text-right">Details Payload</th>
              </tr>
            </thead>
